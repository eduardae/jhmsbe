...
Applicazione **a microservizi solo backend** generata con il comando `jhipster`.
...
To build the final jar and optimize the jhmsbe application for production, run:
